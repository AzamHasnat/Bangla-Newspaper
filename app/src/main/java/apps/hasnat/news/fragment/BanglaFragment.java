...
import apps.hasnat.news.MainActivity;
import apps.hasnat.news.R;
import soup.neumorphism.NeumorphCardView;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link BanglaFragment#newInstance} factory method to
...
public class BanglaFragment extends Fragment {
     ...
     * @return A new instance of fragment BanglaFragment.
     */
    ...
    private void init(View v) {
        prothomalo = v.findViewById(R.id.prothomalo);
        kalerkontho = v.findViewById(R.id.kalerkontho);
